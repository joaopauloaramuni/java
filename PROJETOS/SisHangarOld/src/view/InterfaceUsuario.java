...
public class InterfaceUsuario {
	...
	private static void informarSaidaAeronave() {
		...
		Aeronave objAeronave = objBiz.consultarAeronave(Console.readLine("Digite o id da aeronave: "));
	...
	private static void listarAeronave() {
		...
		System.out.println(objBiz.getMapaAeronaves().toString());
	}
	...
	private static void editarAeronave() {
		...
		Aeronave objAeronave = objBiz.consultarAeronave(Console.readLine("Digite o idAeronave: "));
