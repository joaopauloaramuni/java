...
public class Teste {
    ...
    private static Vector<Cliente> cadClientes = new Vector<Cliente>();
	...
	private static void cadastrarClientes() {
		cadClientes.add(new Cliente(1, "Jose Carlos", "2222-3333", "jcarlos@gmail.com"));
		cadClientes.add(new Cliente(2, "Antonio Carlos", "4444-3333", "acarlos@gmail.com"));
		cadClientes.add(new Cliente(3, "Jose Maria", "3322-3333", "jmaria@gmail.com"));
	}
